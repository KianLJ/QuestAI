...
const EXERCISE_CATALOGUE = [
  ...
  { id: "db-bench-press",        name: "Dumbbell Bench Press",          equipment: "dumbbell",   primaryMuscle: "chest", muscleGroups: ["chest", "triceps", "shoulders"], category: "push" },
  { id: "db-incline-press",      name: "Incline Dumbbell Press",        equipment: "dumbbell",   primaryMuscle: "chest", muscleGroups: ["chest", "shoulders", "triceps"], category: "push" },
  { id: "db-decline-press",      name: "Decline Dumbbell Press",        equipment: "dumbbell",   primaryMuscle: "chest", muscleGroups: ["chest", "triceps"], category: "push" },
  { id: "db-flyes",              name: "Dumbbell Flyes",                equipment: "dumbbell",   primaryMuscle: "chest", muscleGroups: ["chest"], category: "push" },
  { id: "db-incline-flyes",      name: "Incline Dumbbell Flyes",        equipment: "dumbbell",   primaryMuscle: "chest", muscleGroups: ["chest", "shoulders"], category: "push" },
  ...
  { id: "db-shoulder-press",     name: "Seated Dumbbell Shoulder Press",equipment: "dumbbell",   primaryMuscle: "shoulders", muscleGroups: ["shoulders", "triceps"], category: "push" },
  { id: "db-arnold-press",       name: "Arnold Press",                  equipment: "dumbbell",   primaryMuscle: "shoulders", muscleGroups: ["shoulders", "triceps"], category: "push" },
  ...
  { id: "db-lateral-raise",      name: "Dumbbell Lateral Raise",        equipment: "dumbbell",   primaryMuscle: "shoulders", muscleGroups: ["shoulders"], category: "push" },
  ...
  { id: "db-front-raise",        name: "Dumbbell Front Raise",          equipment: "dumbbell",   primaryMuscle: "shoulders", muscleGroups: ["shoulders"], category: "push" },
  { id: "db-rear-delt-fly",      name: "Dumbbell Rear Delt Fly",        equipment: "dumbbell",   primaryMuscle: "shoulders", muscleGroups: ["shoulders", "back"], category: "pull" },
  ...
  { id: "db-curl",               name: "Dumbbell Curl",                 equipment: "dumbbell",   primaryMuscle: "biceps", muscleGroups: ["biceps", "forearms"], category: "pull" },
  { id: "db-hammer-curl",        name: "Hammer Curl",                   equipment: "dumbbell",   primaryMuscle: "biceps", muscleGroups: ["biceps", "forearms"], category: "pull" },
  { id: "db-incline-curl",       name: "Incline Dumbbell Curl",         equipment: "dumbbell",   primaryMuscle: "biceps", muscleGroups: ["biceps"], category: "pull" },
  ...
  { id: "db-bulgarian-split",    name: "Bulgarian Split Squat",         equipment: "dumbbell",   primaryMuscle: "quads", muscleGroups: ["quads", "glutes"], category: "legs" },
  { id: "db-walking-lunge",      name: "Walking Lunge",                 equipment: "dumbbell",   primaryMuscle: "quads", muscleGroups: ["quads", "glutes", "hamstrings"], category: "legs" },
  ...
  { id: "db-step-up",            name: "Dumbbell Step-Up",              equipment: "dumbbell",   primaryMuscle: "quads", muscleGroups: ["quads", "glutes"], category: "legs" },
  ...
  { id: "db-stiff-leg-deadlift", name: "Dumbbell Stiff-Leg Deadlift",   equipment: "dumbbell",   primaryMuscle: "hamstrings", muscleGroups: ["hamstrings", "glutes"], category: "legs" },
  ...
  { id: "db-calf-raise",         name: "Dumbbell Calf Raise",           equipment: "dumbbell",   primaryMuscle: "calves", muscleGroups: ["calves"], category: "legs" },
  ...
  // ===== ABS / CORE =====
  { id: "plank",                 name: "Plank",                         equipment: "bodyweight", primaryMuscle: "abs", muscleGroups: ["abs"], category: "core" },
  { id: "side-plank",            name: "Side Plank",                    equipment: "bodyweight", primaryMuscle: "abs", muscleGroups: ["abs"], category: "core" },
  ...
  { id: "db-wrist-curl",         name: "Dumbbell Wrist Curl",           equipment: "dumbbell",   primaryMuscle: "forearms", muscleGroups: ["forearms"], category: "pull" },
  ...
  { id: "farmers-carry",         name: "Farmer's Carry",                equipment: "dumbbell",   primaryMuscle: "forearms", muscleGroups: ["forearms", "traps", "abs"], category: "pull" },
  ...
  { id: "plate-pinch-hold",      name: "Plate Pinch Hold",              equipment: "bodyweight", primaryMuscle: "forearms", muscleGroups: ["forearms"], category: "pull" },

  // ===== TRAPS =====
  { id: "bb-shrug",              name: "Barbell Shrug",                 equipment: "barbell",    primaryMuscle: "traps", muscleGroups: ["traps"], category: "pull" },
  { id: "db-shrug",              name: "Dumbbell Shrug",                equipment: "dumbbell",   primaryMuscle: "traps", muscleGroups: ["traps"], category: "pull" },
